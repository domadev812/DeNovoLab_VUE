      ...
      <div class="row">
		<div class="wrapper single big_data">
			...
			<ol class="breadcrumb">
				  ...
				  <li class="breadcrumb-item active">QoS Summary</li>
			</ol>
			<h1 class="page-header">QoS Summary</h1>
		...
		data: function(){
            return {
				...
				show_field_options: [
				  ...
				  { id: 4, value: 'total_billable_time', text: 'Total Billable Time' },
				  { id: 5, value: 'total_calls', text: 'Total Calls' },
