      ...
      <div class="row">
		<div class="wrapper single">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Carrier Tenplate</li>
			</ol>
			<h1 class="page-header">Carrier Template</h1>
            <div class="white_pad table_wrap">
                ...
                <router-link to="/template/carrier_template/new" class="btn btn-primary mini pull-right">
	...
	module.exports = {
		...
		methods: {
            ...
            fetchCarrierTemplate () {
                const url = api.getEndpointUrl() + '/v1/config/carrier_template/list'
				this.$http.get(url)
				.then(response => {
