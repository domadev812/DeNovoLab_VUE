      ...
      <div class="row">
		<div class="wrapper single">
			...
			<ol class="breadcrumb">
				  ...
				  <li class="breadcrumb-item active">Random ANI Group</li>
			</ol>
			<h1 class="page-header">Random ANI Group</h1>
					...
					<table class="table table-striped table-hover aliases">
					  ...
					  <tbody>
						<tr v-for="group in groups">
						  ...
						  <td>
                              <router-link to="/switch/random_ani_group/detail" class="blue_link">
                                  {{group.name}}
                              </router-link>
                          </td>
                          <td>{{group.create_time}}</td>
						  <td>
                              <router-link to="/switch/random_ani_group/detail" class="action action_read" data-toggle="tooltip" data-placement="top" title="View Detail">
	...
	module.exports = {
		...
		data: function(){
            return {
			  ...
			  groups: [
				{
				  name: 'CODE_DECK_KALAPI_NEW',
				  create_time: '2017-02-11 14:45:56+00'
				},
                {
				  name: 'CODE_DECK_KALAPI_NEW',
				  create_time: '2017-02-11 14:45:56+00'
