    ...
    <div class="container-fluid">
        <div class="row">
            <div class="wrapper single">
                ...
                <h1 class="page-header">Edit Payment Term</h1>
...
<script>
    ...
    module.exports = {
        created: function() {
            ...
            this.$http.get(api.getEndpointUrl() + '/v1/config/payment_term/' + group_id, {
                headers: {
                ...
                this.day = payload.days[0];
                this.grace_days = payload.grace_period;
                this.selected_term = this.getPaymentTerm(payload.type);
                this.notify_days = 1;
            }, function(error) {
                console.log(error);
            });
        ...
        methods: {
            ...
            getPaymentIndex(id) {
                return _.findIndex(this.payment_options, elem => elem.id === id)
            },
            savePaymentTerm() {
                var group_id = this.$route.params.id;
                this.loading = true;
                ...
                let index = this.getPaymentIndex(this.selected_term)
                requestForm.type = this.payment_options[index].text;
                ...
                this.$http.patch(api.getEndpointUrl() + '/v1/config/payment_term/' + group_id,
                    requestForm, {
                        headers: {
                            "X-Auth-Token": auth.getToken()
                        }
                    ...
                    function(response) {
                        ...
                        this.setMessage('The payment term has been modified!');
                    },
                    function(response) {
                        this.loading = false;
                        console.log(response);
                        this.setMessage({
                            message:"Editing payment term is failed!",
                            type:"error"
                        });
                    }
                )
