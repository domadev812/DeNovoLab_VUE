	...
	<div class="container-fluid">
		<div class="row">
			<div class="wrapper single">
				...
				<h1 class="page-header">Create Currency</h1>
				<router-link to="/switch/currency" class="btn btn_white back"><span class="dnl_icon dnl_import"></span> Back </router-link>
				<div class="white_pad">
		...
		methods : {
			...
			validateBeforeSubmit(){
				this.$validator.validateAll().then(() => {
					...
					this.loading = true;
					this.$http.post(api.getEndpointUrl() + '/v1/switch/currency/create',
					this.requestForm,
					{
						headers: {
						...
						function(response) {
							...
							this.setMessage('The currency has been created!');
						},
						function(response) {
							this.loading = false;
							console.log(response);
							...
							this.setMessage({
								message:"Creating currency is failed!",
								type: "error"
							});
						}
					)
